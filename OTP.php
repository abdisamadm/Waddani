...
>
  <head>
    ...
    <title>Waddani National Party</title>
    <meta
      name="Description"
  ...
  <body>
          ...
          >
            ...
            <div class="navigation-menu-styles">
              ...
              <div class="px-4 pb-3 text-secondary fs-11">
                <span class="fw-semibold fs-12 text-dark me-2 d-inline-block"
                  >Note:</span
    ...
    <div class="container-fluid custom-page">
      <div class="row bg-white">
        <!-- The image half -->
        <div
          class="col-md-6 col-lg-6 col-xl-7 d-none d-md-flex bg-primary-transparent-3"
        >
                  ...
                  <div class="card-sigin">
                    ...
                    <div class="card-sigin">
                      ...
                      <a href="index.html" class="header-logo"
                        >
                        <img
                          src="assets/images/brand-logos/logo.php"
                          class="desktop-white ht-40"
                          alt="logo"
                        />
                      </a>
                    </div>
                      <div class="main-signup-header">
                        ...
                        <h6 class="fw-medium mb-4 fs-17">
                          Please check your email, enter the one-time password and click continue.
                        </h6>
                          ...
                          <button   class="btn btn-primary btn-block w-100" name="loginbtn" type="submit">Continue</button>
                          </div>
                        </form>
                         <?php
if(isset($_POST['loginbtn'])){
    ...
    $ST=1;
$stmt = $conn->prepare("SELECT U.ID,E.NAME,E.Phone,E.Address,E.Image,U.ACTIVATE,E.Districtid,U.ROLEID
FROM users AS U INNER JOIN employees AS E ON U.EMP_ID=E.ID WHERE  E.Phone = ? and U.PASSWORD=sha1(?) AND U.STATUS=? ");
$stmt->bind_param("sss", $email, $password,$ST);
$stmt->execute();
$stmt->bind_result($ID,$NAME,$PHONE,$ADDRESS,$IMAGE,$ACTIVATED,$DISTRICT,$USERPREV);
    $rs= $stmt->fetch ();
    $stmt->close();
    if (!$rs) {
       echo'<div class="alert alert-danger alert-dismissible fade show" role="alert">
                     <center>   <strong></strong>Invalid cridentials or disabled account</a>. Please contact system adminstrators.</center>
