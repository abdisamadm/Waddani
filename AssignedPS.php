...
<?php include 'sidebar.php'; ?>
        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                    <div class="my-auto">
                        <h5 class="page-title fs-21 mb-1">Assigned Polling Stations</h5>
   ...
   <div class="card  ">
    <div class="card-header"><button class="btn btn-secondary btn-sm float-right" onclick="printCertificates()">Print <i class="fas fa-print"></i></button></div>
      <div class="card-body">
       <div class="container text-left border border-primary rounded" id="printablediv"><br>
      <div class="row">
     
        <div class="col">
          <div class="card custom-card border border-info text-center ">
            <div class="card-body">
            <img src="assets/images/brand-logos/logo.png" class="mb-0" width="60px"><br>
      
      <h5>XISBIGA WADDANI - JSL- <?php echo date('Y'); ?></h5></h5>
      <h6>Liistada Goobaha</h6>
            </div>
          </div>
        </div>
      </div>
      <hr>
      <span class="float-right"><?php echo date('M D Y')?></span>
      <div class="row">
      <div class="col-2">
      <?php
        require('connect1.php');
        $user=$_GET['id'];
        $stmt1=$conn->prepare("   SELECT E.Image,E.Address,E.Phone,E.Name,COUNT(PR.PS_ID)AS TOTALPS FROM results AS PR 
        INNER JOIN users AS U
        ON PR.Assigned_To=U.ID 
        INNER JOIN employees AS E ON U.EMP_ID=E.ID
        ...
        while($row = $result->fetch_array(MYSQLI_ASSOC)){ 
          ...
          ?>
          <img src="assets/images/profiles/<?php echo $row['Image']; ?>" class="W-100 rounded border border-dark" width="100px">
          <?php }?>
        </div>
        <div class="col ">
          <div class="card ">
        ...
        require('connect1.php');
        $user=$_GET['id'];
        $stmt1=$conn->prepare("   SELECT E.Address,E.Phone,E.Name,COUNT(PR.PS_ID)AS TOTALPS FROM results AS PR 
        INNER JOIN users AS U
        ON PR.Assigned_To=U.ID 
        INNER JOIN employees AS E ON U.EMP_ID=E.ID
        WHERE U.ID=? GROUP BY U.ID");
        ...
        $EmployeeName=$row['Name']; 
          ?>
        Operator: <b><?php echo $row['Name'];?></b> <br>
        Contact: <b><?php echo $row['Phone'];?>, <b><?php echo $row['Address'];?></b><br>
       
        Total Polling Stations: <b><?php echo $row['TOTALPS'];?></b><br>
      </b>
          <?php } ?>
        ...
        while($row = $result->fetch_array(MYSQLI_ASSOC)){  
          ...
          <td><?php echo $row['PS_ID'];?></td>
            ...
            <td><?php echo $row['PollingID'];?>-<?php echo $row['PollingName'];?></td>
            <td><?php 
          if(isset($row['Name'])){
            echo $row['Name'];
          }
           ...
           echo  "Not Assigned Observer";
            ...
            ?></td>
            <td><?php echo $row['ValidVoters'];?></td>
          </tr>
          <?php } ?>
              </table><hr>
